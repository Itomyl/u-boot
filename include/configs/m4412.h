 ...
 *
 * Configuration settings for the SAMSUNG M4412 (EXYNOS4412) board.
 *
 * SPDX-License-Identifier:    GPL-2.0+
 */

#ifndef __CONFIG_M4412_H
#define __CONFIG_M4412_H

#include <configs/exynos4-common.h>

/* High Level Configuration Options */
#define CONFIG_M4412			1
#define CONFIG_MACH_TYPE		MACH_TYPE_M4412
...
#define CONFIG_DEBUG_UART_BASE		0x13820000	    /* UART0 base address  */
...
#define CONFIG_SYS_INIT_SP_ADDR		0x43E00000	
...
#define CONFIG_BOOTCOMMAND \
                                        ...
                                        "load mmc ${mmcdev} ${dtaddr} exynos4412-m4412.dtb; bootm ${loadaddr} "

#define CONFIG_IDENT_STRING		" for M4412"
